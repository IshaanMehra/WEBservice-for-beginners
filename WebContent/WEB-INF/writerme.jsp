...
conn = DriverManager.getConnection("jdbc:oracle:thin:@192.168.1.120:1524:VIS","scott","tiger");
out.println("Oracle Connected.");
ResultSetMetaData rsmd;
ResultSet rs1 = null;
ResultSet rsnew=null;
PreparedStatement ps1=null;
String st="Select * from sales_order_master";
try{%>
<tr><%
...
{
%>
<tr><td><%=rs1.getString(1)%></td><td><%=rs1.getString(2)%></td><td><%=rs1.getString(3)%></td><td><%=rs1.getString(4)%></tr>
<%
}
}
catch(Exception e)
